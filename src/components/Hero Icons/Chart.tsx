...
function Chart() {
  return (
    <div className=" w-max h-max bg-primary drop-shadow-xl shadow-2xl rounded-xl flex  absolute items-center justify-center gap-5 p-1 lg:top-[15rem] -right-[4rem] z-30 cursor lg:scale-90 scale-50 top-[2rem]">
